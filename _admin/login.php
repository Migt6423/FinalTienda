...
<div class="login">
    ...
    <form action="../config/procesar_login.php" method="post">
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Ingrese correo" name="usuario" id="usuario">
            ...
            <button type="submit" class="btn btn-primary btn-block btn-large" name="login">Ingresar</button>
		
        </form>

	<a href="/latienda/index.php" class="btn btn-primary btn-block btn-large">Volver al Inicio</a>
